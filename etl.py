...
"""
Read songs log file by row, selects needed fields and inserts them into song and artist tables.
...
def process_log_file(cur, filepath):
    ...
    """
    Read user activity log file row by row, filter by NextSong, selects needed files, transforms them and insert them into time, user and songplay table
...
def process_data(cur, conn, filepath, func):
    """
    Go through all files under filepath, and processes all logs found.
   Parameters:
       cur(psycopg2.cursor()):Cursor of the sparkifydb database
       conn(psycopg2.connect()):Connect to the sparkifycdb database
